        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-white rounded-2xl border border-slate-200/60 p-6 shadow-sm shadow-slate-100/50">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
                    ...
                    <a href="{{ route('provinsi.donasi.index') }}" class="group flex items-center gap-4 border border-slate-100 rounded-xl p-4 hover:bg-slate-50 hover:border-slate-300/80 active:scale-[0.98] transition-all duration-200">
                        <div class="w-10 h-10 bg-slate-50 text-slate-700 rounded-lg flex items-center justify-center group-hover:bg-rose-600 group-hover:text-white transition duration-200 shrink-0 shadow-sm border border-slate-100">
                            <svg class="w-5 h-5 stroke-[1.5]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z"/></svg>
                        </div>
                        <div class="truncate">
                            <span class="block text-sm font-semibold text-slate-800 group-hover:text-rose-600 transition truncate">Kelola Donasi</span>
                            <span class="text-xs text-slate-400 block mt-0.5 truncate">Verifikasi masuk</span>
                        </div>
                    </a>
                </div>
            </div>
