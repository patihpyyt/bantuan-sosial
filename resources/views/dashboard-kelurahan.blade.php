<x-app-layout>
    ...
    <div class="truncate">
        <span class="block text-sm font-semibold text-slate-800 group-hover:text-green-600 transition truncate">Menerima Dana</span>
        <span class="text-xs text-slate-400 block mt-0.5 truncate">Dari Kecamatan</span>
    </div>
</a>
