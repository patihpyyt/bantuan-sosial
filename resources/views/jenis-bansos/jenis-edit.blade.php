    ...
    <div class="py-8 bg-gray-50 min-h-screen">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <h2 class="font-bold text-xl text-gray-800">Edit Jenis Bantuan</h2>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-8">
                ...
                @endif
                        ...
                        <form method="POST" action="/jenis-bansos/{{ $jenisBansos->id }}">
                        @csrf
                        @method('PUT')
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="nama_bansos"
                                   value="{{ old('nama_bansos', $jenisBansos->nama_bansos) }}"
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi"
                                      rows="3"
                                      class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-400">{{ old('deskripsi', $jenisBansos->deskripsi) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number"
                                   name="jumlah_bantuan"
                                   value="{{ old('jumlah_bantuan', $jenisBansos->jumlah_bantuan) }}"
