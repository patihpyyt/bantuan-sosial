<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-bold text-xl text-gray-800">Tambah Data Warga</h2>
    ...
    <div class="py-8 bg-gray-50 min-h-screen">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-8">
                ...
                <h3 class="text-base font-semibold text-gray-700 mb-6">Form Data Warga</h3>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="alamat"
                                      ...
                                      class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-400 @error('alamat') border-red-400 @enderror">{{ old('alamat') }}</textarea>
