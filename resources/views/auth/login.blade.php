<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        {{-- TOMBOL UTAMA (Kembali ke Biru Asli Anda + Efek Shadow Pas) --}}
        <div class="pt-2">
            <button type="submit" 
        ...
        <div class="border-t border-slate-200 pt-5 mt-5">
            ...
            {{-- GRID LINKS (Ikon Garis Hitam-Putih Minimalis) --}}
            <div class="grid grid-cols-2 gap-3">
                <a href="{{ route('login.provinsi') }}"
                    class="flex items-center justify-center gap-2 text-center py-2 rounded-lg border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 text-sm font-semibold transition">
            ...
            <div class="mt-4">
                <a href="{{ route('login.warga') }}"
                    class="flex items-center justify-center gap-2 block w-full text-center py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold transition">
